...
<body class="bg-gray-100">
      ...
      <main class="max-w-7xl mx-auto py-6 px-6">
        ...
        <?php else: ?>
          ...
          <div class="bg-white shadow rounded-lg p-4 mb-6 no-print">
            <div class="flex flex-wrap items-center justify-between">
              ...
              <div class="flex space-x-3 mt-4 md:mt-0">
                ...
                <a href="admin_dashboard.php?tab=visualization" class="bg-blue-500 hover:bg-blue-600 text-white py-2 px-4 rounded shadow-sm">
          ...
          <div class="bg-white shadow rounded-lg p-6 mb-6">
            ...
            function countTreeStats($nodes, &$totalUsers, &$totalEarnings, &$totalBalance)
            {
              foreach ($nodes as $node) {
                ...
                if (!empty($node['children'])) {
                  countTreeStats($node['children'], $totalUsers, $totalEarnings, $totalBalance);
                }
              }
            }

            if (!empty($treeData['tree'])) {
              countTreeStats($treeData['tree'], $totalUsers, $totalEarnings, $totalBalance);
            }
            ?>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
              ...
              <div class="bg-green-50 rounded-lg p-4 border border-green-200">
                <h4 class="text-green-700 text-lg font-medium">Total Earnings</h4>
                <p class="text-2xl font-bold">$<?php echo number_format($totalEarnings, 2); ?></p>
                <p class="text-green-600 text-sm">From commissions</p>
              </div>
              ...
              <div class="bg-orange-50 rounded-lg p-4 border border-orange-200">
                <h4 class="text-orange-700 text-lg font-medium">Max Depth</h4>
                <p class="text-2xl font-bold"><?php echo $maxDepth; ?> levels</p>
                <p class="text-orange-600 text-sm">Tree structure</p>
              </div>
            </div>
          </div>
  ...
  <script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
      // Nothing specific needed at the moment
    });
  </script>
</body>
